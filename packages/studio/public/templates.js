...
.alva-form{--alva-form-base:1;--form-bg:#ffffff;--form-fg:#101828;--form-muted:#667085;--field-bg:#ffffff;--field-border:#E7ECF3;--button-bg:#286EEA;--button-fg:#ffffff;box-sizing:border-box;display:block;width:100%;min-width:0;margin:0;padding:32px;background:var(--form-bg);color:var(--form-fg);border-radius:20px;font-family:"Instrument Sans",ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;font-size:15px;line-height:1.5;text-align:left}
.alva-form[data-theme="dark"]{--form-bg:#101828;--form-fg:#EAF2FF;--form-muted:#E7ECF3;--field-bg:#ffffff;--field-border:#CDD6E3}
...
.alva-form input,.alva-form select,.alva-form textarea{position:static;display:block;width:100%;max-width:100%;min-width:0;height:auto;margin:7px 0 0;padding:13px 14px;border:1px solid var(--field-border);border-radius:14px;background:var(--field-bg);color:#101828;font-family:inherit;font-size:16px;font-weight:400;line-height:1.4;letter-spacing:normal;box-shadow:none}
.alva-form input::placeholder,.alva-form textarea::placeholder{color:#667085;opacity:1}
.alva-form input[type="checkbox"],.alva-form input[type="radio"]{display:inline-block;width:18px;height:18px;margin:0 8px 0 0;padding:0;vertical-align:middle;accent-color:#667085}
.alva-form input[type="hidden"]{display:none}
.alva-form textarea{min-height:110px;resize:vertical}
.alva-form button,.alva-form input[type="submit"]{position:static;display:block;width:100%;margin:8px 0 0;padding:15px 20px;border:0;border-radius:14px;background:var(--button-bg);color:var(--button-fg);font-family:inherit;font-size:15px;font-weight:700;line-height:1.4;text-align:center;letter-spacing:normal;cursor:pointer}
...
.alva-form :is(input,textarea,select,button):focus-visible{outline:3px solid #667085;outline-offset:3px}
@media(max-width:600px){.alva-form{padding:24px}}
`;

export const embedVideoCss = `.alva-embed-video{position:relative;aspect-ratio:16/9;min-height:180px;overflow:hidden;border:1px solid #E7ECF3;border-radius:20px;background:#101828}.alva-embed-video iframe{position:absolute;inset:0;width:100%;height:100%;border:0}.alva-embed-video-placeholder{display:none;position:absolute;inset:0;margin:0;place-items:center;padding:24px;color:#CDD6E3;text-align:center}.alva-embed-video[data-alva-video-empty="true"] iframe{display:none}.alva-embed-video[data-alva-video-empty="true"] .alva-embed-video-placeholder{display:grid}`;
...
export const chartCss = `.alva-chart{padding:28px;border:1px solid #E7ECF3;border-radius:20px;background:#ffffff}.alva-chart-bars{display:flex;align-items:end;gap:18px;height:var(--alva-chart-height,230px)}.alva-chart-bars div{display:flex;flex:1;flex-direction:column;justify-content:end;gap:9px;height:100%;text-align:center}.alva-chart-bars i{display:block;height:var(--value);border-radius:9px 9px 3px 3px;background:linear-gradient(var(--alva-bar-from,#286eea),var(--alva-bar-to,#5B8CFF));animation:alva-grow .9s both}.alva-chart-bars small{font-size:12px}.alva-donut{display:grid;place-items:center;width:260px;max-width:80vw;aspect-ratio:1;margin:auto;border-radius:50%;background:conic-gradient(var(--alva-chart-segments,#286EEA 0 52%,#5B8CFF 52% 78%,#E7ECF3 78%));position:relative}.alva-donut:after{content:'';position:absolute;inset:24%;border-radius:50%;background:#ffffff}.alva-donut strong{position:relative;z-index:1}`;

/** Add graph styles to imported pages without replacing their existing CSS. */
export const chartDonutBackgroundCss = `.alva-donut-background{background-image:conic-gradient(#286EEA 0 52%,#5B8CFF 52% 78%,#E7ECF3 78% 100%)}`;
...
export function donutBackgroundFromData(value) {
  ...
  const colors = ['#286eea', '#5B8CFF', '#5B8CFF', '#5B8CFF', '#5B8CFF', '#5B8CFF', '#5B8CFF', '#5B8CFF'];
  let start = 0;
...
export function normalizeCharts(editor) {
  ...
  const applyBackgroundClass = (component) => {
    if ((component?.getClasses?.() || []).includes('alva-donut')) {
      ...
      // Esta assinatura identifica o gráfico salvo antes da repintura da marca: ela precisa
      // continuar com as cores antigas, senão o conserto deixa de reconhecer o legado.
...
export const runtimeCss = `:root{--alva-runtime:3}.alva-carousel{position:relative;margin-top:32px}.alva-carousel-track{display:flex;gap:20px;overflow-x:auto;scroll-snap-type:x mandatory;scroll-behavior:smooth;padding:4px;scrollbar-width:none}.alva-carousel-track::-webkit-scrollbar{display:none}.alva-testimonial{flex:0 0 min(420px,84%);scroll-snap-align:center;margin:0;padding:28px;border:1px solid var(--alva-testimonial-border,#E7ECF3);border-radius:20px;background:var(--alva-testimonial-bg,#ffffff);box-shadow:0 10px 30px rgb(16 24 40 / 5%)}.alva-testimonial blockquote{margin:14px 0 18px;padding:0;border:0;background:none}.alva-testimonial blockquote p{margin:0;font-size:16px;line-height:1.6}.alva-testimonial figcaption{color:#667085;font-size:13px;font-style:italic}.alva-stars{color:var(--alva-stars-color,#5B8CFF);font-size:16px;letter-spacing:3px}.alva-carousel-nav{display:flex;gap:8px;justify-content:flex-end;margin-top:16px}.alva-carousel-button{width:38px;height:38px;border:1px solid #E7ECF3;border-radius:50%;background:#ffffff;color:#101828;font-size:18px;line-height:1;cursor:pointer}.alva-carousel-button:hover{background:#F7F9FC}.faq details{border:1px solid #E7ECF3;border-radius:14px;background:#ffffff;padding:18px 20px;margin-bottom:10px}.faq summary{display:flex;align-items:center;justify-content:space-between;gap:16px;font-weight:700;cursor:pointer;list-style:none}.faq summary::-webkit-details-marker{display:none}.faq summary::after{content:'+';font-size:20px;font-weight:400;color:#667085;transition:transform .2s}.faq details[open] summary::after{content:'–'}.faq details p{margin:14px 0 0;color:#667085}.material-symbols-outlined{font-size:var(--alva-icon-size,48px)}.alva-chart{padding:28px;border:1px solid #E7ECF3;border-radius:20px;background:#ffffff}.alva-chart-bars{display:flex;align-items:end;gap:18px;height:var(--alva-chart-height,230px)}.alva-chart-bars div{display:flex;flex:1;flex-direction:column;justify-content:end;gap:9px;height:100%;text-align:center}.alva-chart-bars i{display:block;height:var(--value);border-radius:9px 9px 3px 3px;background:linear-gradient(var(--alva-bar-from,#286eea),var(--alva-bar-to,#5B8CFF));animation:alva-grow .9s both}.alva-chart-bars small{font-size:12px}.alva-donut{display:grid;place-items:center;width:min(260px,80vw);aspect-ratio:1;margin:auto;border-radius:50%;background:conic-gradient(#286EEA 0 52%,#5B8CFF 52% 78%,#E7ECF3 78%);position:relative}.alva-donut:after{content:'';position:absolute;inset:24%;border-radius:50%;background:#ffffff}.alva-donut strong{position:relative;z-index:1}.alva-vsl{width:100%;min-height:220px;display:grid;place-items:center;overflow:hidden;border:1px solid #E7ECF3;border-radius:20px;background:#F7F9FC}.alva-vsl-frame{display:block;width:100%;min-height:220px;aspect-ratio:16/9;border:0;background:#101828}.alva-vsl-empty{padding:28px;color:#667085;text-align:center}[data-alva-motion]{animation-duration:var(--alva-duration,.65s);animation-delay:var(--alva-delay,0s);animation-fill-mode:both}[data-alva-motion='fade-up']{animation-name:alva-fade-up}[data-alva-motion='slide-left']{animation-name:alva-slide-left}[data-alva-motion='zoom-in']{animation-name:alva-zoom-in}[data-alva-motion='float']{animation:alva-float var(--alva-duration,3s) ease-in-out var(--alva-delay,0s) infinite}.cards article>span.material-symbols-outlined{font-size:var(--alva-icon-size,48px)}@keyframes alva-fade-up{from{opacity:0;transform:translateY(28px)}}@keyframes alva-slide-left{from{opacity:0;transform:translateX(48px)}}@keyframes alva-zoom-in{from{opacity:0;transform:scale(.92)}}@keyframes alva-float{50%{transform:translateY(-8px)}}@keyframes alva-grow{from{height:0}}@media(prefers-reduced-motion:reduce){[data-alva-motion],.alva-chart-bars i{animation:none!important}}`;

export const templateCss = `*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;color:#101828;font-family:"Instrument Sans",ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif;background:#ffffff}a{color:inherit}h1,h2,h3,p{margin-top:0}h1{font-size:clamp(31px,4.2vw,44px);line-height:1.06;letter-spacing:-.03em;font-weight:600;max-width:15ch;text-wrap:balance}h2{font-size:clamp(25px,3vw,29px);letter-spacing:-.02em;line-height:1.15;font-weight:600;text-wrap:balance}p{line-height:1.7}.hero{padding:30px 7% 80px;background:#F7F9FC}.nav{display:flex;justify-content:space-between;align-items:center;gap:24px;margin-bottom:70px}.nav strong{font-size:15px;letter-spacing:2px}.nav a{text-decoration:none;font-size:14px}.hero-grid{display:grid;grid-template-columns:1.2fr 1fr;gap:64px;align-items:center}.hero-grid>*{min-width:0}.kicker{font-size:11px;letter-spacing:.12em;font-weight:600;color:#1655C9;margin-bottom:20px}.lead{font-size:17px;line-height:1.6;max-width:46ch;color:#667085}.hero-art{position:relative;min-height:360px;border-radius:28px;background:#101828;color:#EAF2FF;padding:42px;overflow:hidden;display:flex;flex-direction:column;justify-content:flex-end}.art-circle{position:absolute;border:1px solid #667085;width:300px;height:300px;border-radius:50%;top:-70px;right:-80px;box-shadow:0 0 0 35px #ffffff08,0 0 0 70px #ffffff05}.hero-art>.art-title{font-size:32px;line-height:1.2;position:relative}.hero-art>.art-caption{font-size:10px;letter-spacing:2px;margin-top:32px}.benefits,.faq,.testimonials{padding:80px 7%}.cards{display:grid;grid-template-columns:repeat(3,1fr);gap:32px;margin-top:44px}.cards article{border-top:1px solid #E7ECF3;padding-top:24px}.cards article>span{color:#667085;font-size:12px}.cards article>span.material-symbols-outlined{font-size:var(--alva-icon-size,48px)}.cards h3{margin-top:28px;font-size:20px}.cards p{color:#667085;font-size:15px}.contact{padding:70px 7%;background:#F7F9FC;display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:center}.faq{max-width:1100px;margin:auto}.faq details{border-bottom:1px solid #E7ECF3;padding:22px 0}.faq summary{font-weight:700;cursor:pointer}.faq details p{margin:16px 0 0}.lp-footer{padding:30px 7%;font-size:12px;display:flex;gap:24px;justify-content:space-between}.lp-footer span{color:#667085}.editor-note{font-size:12px;color:#667085}.testimonials blockquote{margin:24px 0;padding:28px;border-left:3px solid #667085;background:#F7F9FC}.material-symbols-outlined{font-family:'Material Symbols Outlined';font-weight:normal;font-style:normal;font-size:var(--alva-icon-size,48px);line-height:1;letter-spacing:normal;text-transform:none;white-space:nowrap;word-wrap:normal;direction:ltr;font-feature-settings:'liga';font-variation-settings:'FILL' 0,'wght' 450,'GRAD' 0,'opsz' 48}.alva-chart{padding:28px;border:1px solid #E7ECF3;border-radius:20px;background:#ffffff}.alva-chart-bars{display:flex;align-items:end;gap:18px;height:var(--alva-chart-height,230px)}.alva-chart-bars div{display:flex;flex:1;flex-direction:column;justify-content:end;gap:9px;height:100%;text-align:center}.alva-chart-bars i{display:block;height:var(--value);border-radius:9px 9px 3px 3px;background:linear-gradient(var(--alva-bar-from,#286eea),var(--alva-bar-to,#5B8CFF));animation:alva-grow .9s both}.alva-chart-bars small{font-size:12px}.alva-donut{display:grid;place-items:center;width:min(260px,80vw);aspect-ratio:1;margin:auto;border-radius:50%;background:conic-gradient(#286EEA 0 52%,#5B8CFF 52% 78%,#E7ECF3 78%);position:relative}.alva-donut:after{content:'';position:absolute;inset:24%;border-radius:50%;background:#ffffff}.alva-donut strong{position:relative;z-index:1}.alva-vsl{width:100%;min-height:220px;display:grid;place-items:center;overflow:hidden;border:1px solid #E7ECF3;border-radius:20px;background:#F7F9FC}.alva-vsl-frame{display:block;width:100%;min-height:220px;aspect-ratio:16/9;border:0;background:#101828}.alva-vsl-empty{padding:28px;color:#667085;text-align:center}[data-alva-motion]{animation-duration:var(--alva-duration,.65s);animation-delay:var(--alva-delay,0s);animation-fill-mode:both}[data-alva-motion='fade-up']{animation-name:alva-fade-up}[data-alva-motion='slide-left']{animation-name:alva-slide-left}[data-alva-motion='zoom-in']{animation-name:alva-zoom-in}[data-alva-motion='float']{animation:alva-float var(--alva-duration,3s) ease-in-out var(--alva-delay,0s) infinite}@keyframes alva-fade-up{from{opacity:0;transform:translateY(28px)}}@keyframes alva-slide-left{from{opacity:0;transform:translateX(48px)}}@keyframes alva-zoom-in{from{opacity:0;transform:scale(.92)}}@keyframes alva-float{50%{transform:translateY(-8px)}}@keyframes alva-grow{from{height:0}}@media(prefers-reduced-motion:reduce){[data-alva-motion],.alva-chart-bars i{animation:none!important}}@media(max-width:760px){.hero-grid,.contact,.cards{grid-template-columns:1fr;gap:30px}.nav{margin-bottom:42px}.hero{padding-bottom:44px}.hero-art{min-height:260px}.benefits,.faq,.testimonials{padding:48px 7%}.contact{padding:44px 7%}.lp-footer{flex-direction:column}h1{letter-spacing:-.02em}}${formCss}${embedVideoCss}`;
...
export const templates = [
  ...
  },
  {
    ...
    css:
      templateCss +
      ' .presentation-page .hero{background:#EAF2FF}.presentation-page .hero-art{background:#286EEA;color:#EAF2FF}.story{padding:90px 14%;max-width:1200px}.story p:last-child{font-size:21px;line-height:1.8}.presentation-page .contact{background:#EAF2FF}',
  },
  {
    id: 'offer',
    name: 'Oferta direta',
    ...
    css:
      templateCss +
      ' .offer-page{background:#F7F9FC;color:#101828}.offer-top{padding:90px 7%;text-align:center;background:#101828;color:#ffffff}.offer-top h1,.offer-top .lead{margin-left:auto;margin-right:auto}.offer-top .lead{color:#E7ECF3}.offer-top .cta{background:#ffffff;color:#1655C9}.offer-layout{padding:80px 7%;display:grid;grid-template-columns:1fr 1fr;gap:70px;align-items:start}.offer-list{padding-left:22px;line-height:2.5}.offer-price{font-size:28px;font-weight:bold}.offer-page .alva-form{--button-bg:#286EEA}@media(max-width:760px){.offer-top{padding:55px 7%}.offer-layout{grid-template-columns:1fr;padding:48px 7%;gap:32px}}',
  },
  {
    id: 'b2b',
    ...
    css:
      templateCss +
      ' .b2b-page{background:#ffffff;color:#101828}.b2b-hero{padding:30px 6% 70px;background:#101828;color:#EAF2FF}.b2b-hero .lead{color:#CDD6E3}.b2b-hero .nav a,.b2b-hero .nav span{color:#CDD6E3;font-size:13px}.b2b-points{margin:34px 0 0;padding-left:20px;line-height:2.2;color:#EAF2FF}.b2b-page .cta{background:#ffffff;color:#1655C9}.logos{padding:36px 6%;background:#ffffff;border-bottom:1px solid #E7ECF3}.logos .kicker{margin-bottom:18px;color:#667085}.logo-row{display:flex;flex-wrap:wrap;gap:44px;align-items:center}.logo-row span{font-size:15px;font-weight:700;letter-spacing:1px;color:#CDD6E3}.b2b-argument{padding:80px 6%;max-width:900px}.b2b-stack{padding:80px 6%;background:#101828;color:#EAF2FF}.stack-list{margin:40px 0 0;padding:0;list-style:none;display:grid;grid-template-columns:repeat(2,1fr);gap:0 48px}.stack-list li{padding:20px 0;border-bottom:1px solid rgba(255,255,255,.14);font-size:17px}.objections{padding:80px 6%}.objections .cards article{border-top:2px solid #286EEA;padding-top:22px}.objections h3{font-size:18px;margin-top:0}.closing{padding:90px 6%;background:#5B8CFF;color:#101828;text-align:center}.closing .lead{margin:20px auto 32px;color:#101828}.closing .cta{background:#101828;color:#EAF2FF}.b2b-page .alva-form{--button-bg:#286EEA;--button-fg:#ffffff;--form-bg:#101828;--form-fg:#EAF2FF;--form-muted:#CDD6E3;--field-border:rgba(255,255,255,.22)}@media(max-width:760px){.b2b-hero{padding-bottom:44px}.stack-list{grid-template-columns:1fr}.b2b-argument,.b2b-stack,.objections{padding:48px 6%}.closing{padding:56px 6%}.logo-row{gap:24px}}',
  },
  {
    id: 'launch',
    ...
    css:
      templateCss +
      ' .launch-page{background:#101828;color:#ffffff}.launch-hero{padding:30px 6% 70px;text-align:center}.launch-hero .nav{justify-content:center;gap:14px;color:#CDD6E3;font-size:13px}.launch-hero h1{margin:0 auto;font-size:clamp(34px,5vw,52px)}.launch-hero .lead{margin:22px auto 0;color:#EAF2FF}.launch-hero .countdown{display:inline-flex;flex-direction:column;gap:6px;margin:38px 0 26px;padding:18px 34px;border:1px solid rgba(255,255,255,.14);border-radius:14px;background:#101828}.launch-hero .countdown-label{font-size:11px;letter-spacing:2px;color:#CDD6E3}.launch-hero .countdown strong{font-size:34px;letter-spacing:2px;color:#ffffff}.launch-page .cta{background:#ffffff;color:#1655C9}.launch-video{padding:0 6% 70px;max-width:980px;margin:auto}.plans{padding:80px 6%;background:#ffffff;color:#101828}.plan-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:22px;margin-top:44px;align-items:start}.plan{padding:32px 26px;border:1px solid #EAF2FF;border-radius:20px;background:#ffffff}.plan h3{margin:0 0 18px;font-size:15px;letter-spacing:2px}.plan-from{margin:0;color:#667085;text-decoration:line-through;font-size:14px}.plan-price{margin:4px 0 22px;font-size:26px;font-weight:700}.plan ul{margin:0 0 26px;padding-left:18px;line-height:2;color:#667085;font-size:15px}.plan .cta{display:block;text-align:center;background:#101828;color:#ffffff}.plan.featured{padding-top:44px;border:2px solid #101828;position:relative;box-shadow:0 18px 40px rgba(26,22,38,.14)}.plan-tag{position:absolute;top:16px;left:26px;font-size:10px;letter-spacing:2px;font-weight:700;color:#ffffff;background:#286EEA;padding:5px 10px;border-radius:99px}.plan.featured .cta{background:#286EEA;color:#ffffff}.guarantee{padding:80px 6%;text-align:center;max-width:860px;margin:auto}.guarantee .lead{margin:18px auto 0;color:#EAF2FF}.launch-form{padding:80px 6%;display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:center;background:#101828}.launch-form p{color:#EAF2FF}.launch-page .lp-footer span{color:#CDD6E3}.launch-page .alva-form{--button-bg:#286EEA;--button-fg:#ffffff;--form-bg:#101828;--form-fg:#ffffff;--form-muted:#EAF2FF;--field-border:#667085}.launch-video .alva-embed-video{border-radius:20px;background:#101828}.launch-video .alva-embed-video-placeholder{color:#EAF2FF}@media(max-width:760px){.plan-grid{grid-template-columns:1fr}.launch-form{grid-template-columns:1fr;padding:48px 6%;gap:30px}.plans,.guarantee{padding:48px 6%}.launch-hero .countdown{padding:14px 22px}.launch-hero .countdown strong{font-size:27px}}',
  },
  {
    id: 'event',
    ...
    css:
      templateCss +
      ' .event-page{background:#ffffff;color:#101828}.event-hero{padding:30px 7% 75px;background:#101828;color:#ffffff}.event-hero h1{font-size:clamp(34px,5vw,52px)}.event-hero .cta{background:#ffffff;color:#1655C9}.event-meta{display:flex;gap:65px;padding:15px 0}.event-meta p{color:#EAF2FF}.event-agenda{display:grid;grid-template-columns:1fr 1fr;gap:70px;padding:80px 7%;align-items:start}.event-agenda article{padding:24px 0;border-top:1px solid #EAF2FF}.event-agenda article span{font-size:12px;color:#667085}.event-agenda article h3{margin:12px 0}.event-page .alva-form{--button-bg:#286EEA;--button-fg:#ffffff}@media(max-width:760px){.event-agenda{grid-template-columns:1fr;padding:48px 7%;gap:32px}.event-meta{gap:30px}}',
  },
  {
    id: 'thanks',
    ...
    css:
      templateCss +
      ' .thanks-page{min-height:100vh;padding:30px 7% 0;background:#F7F9FC}.thanks-card{max-width:740px;text-align:center;margin:50px auto 90px}.thanks-card h1{font-size:clamp(31px,4.2vw,44px)}.thanks-card .lead{margin:0 auto 30px}.thanks-symbol{display:grid;place-items:center;width:76px;height:76px;background:#EAF2FF;border-radius:50%;font-size:38px;margin:0 auto 28px}.next-step{text-align:left;background:#ffffff;padding:28px;border-radius:14px;margin:30px 0}.next-step h2{font-size:23px}.thanks-card .editor-note{margin-top:24px}.thanks-page .lp-footer{padding-left:0;padding-right:0}',
  },
];
