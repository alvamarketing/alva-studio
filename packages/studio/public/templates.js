...
export const blocks = [
  ...
  ['embedded-video', 'Vídeo incorporado', 'Mídia', '<div class="alva-embed-video" data-alva-video-empty="true"><iframe src="about:blank" title="Vídeo incorporado" loading="lazy" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe><p class="alva-embed-video-placeholder">Cole uma URL HTTPS para incorporar o vídeo.</p></div>'],
  ['vsl', 'VSL', 'Mídia', { type: 'vsl', publicId: '', attributes: { 'data-alva-vsl': '' } }],
