...
export function createOwnerUI({ api, onAuthenticated, onLoggedOut, onSettingsChanged, beforeLogout, toast }) {
  ...
  host.innerHTML = `
    <section class="access-gate" id="access-gate" aria-label="Acesso ao Alva Studio" hidden>
      <div class="access-story"><a class="brand" href="/">alva<span>studio</span><i>↗</i></a><div><span class="eyebrow">SEU ESPAÇO DE CRIAÇÃO</span><h1>Suas ideias.<br>Sua próxima<br><em>campanha.</em></h1><p>Crie páginas com a sua cara.<br>Do primeiro bloco à publicação.</p></div><small>ALVA MARKETING / STUDIO</small></div>
