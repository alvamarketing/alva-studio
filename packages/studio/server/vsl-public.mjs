...
export function vslContentSecurityPolicy(sourceUrl, { embed = false, posterUrl = '', captionsUrl = '' } = {}) {
  ...
  const connectOrigins = origins(sourceOrigin, captionsOrigin);
...
export function renderVslPage(video, { embed = false, publicOrigin = '' } = {}) {
